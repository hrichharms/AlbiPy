...
**Note: For the time being, AlbiPy is only confirmed to work on Linux and Windows 10. It is not guaranteed to work on previous versions of Windows nor on Mac OS.**

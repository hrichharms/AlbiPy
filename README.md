...
**Note: For the time being, AlbiPy is only confirmed to work on Linux. It may not run properly on MAC OSX and Windows 10 definetely doesn't work at the moment.**
